...
let package = Package(
	...
	targets: [
		.binaryTarget(
			...
			url: "https://storage.googleapis.com/cpass-sdk/libs/iOS/internal/jv_watch_party/spm_Demo/JioMeetWatchParty.xcframework.zip",
			checksum: "158cbae4cbdc3b7bc72b3970fbdff5b80cab16f4346b990f9de8b1caf2f05f7a"
		),
		.target(
